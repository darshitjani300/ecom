  ...
  const list = [
    {
      ...
      styles:
        "border-black border-[1px] text-[12px] 2xl:text-[1rem] tracking-[1px] font-semibold py-1 px-3 bg-black text-white",
    },
    {
    ...
    },
    {
      ...
      id: crypto.randomUUID(),
      styles:
        "border-black text-[12px] 2xl:text-[1rem] tracking-[1px] font-semibold border-black border-[1px] py-1 px-3 bg-black text-white",
    },
  ];
  return (
    <section className="my-[50px] md:py-0 md:px-[100px] px-5">
      ...
      <div className="flex justify-between lg:text-[14px] 2xl:text-[1.3rem] text-gray-500">
        ...
        <a href="#" className="hidden lg:block text-[12px] 2xl:text-[13rem]">
          See All Products
